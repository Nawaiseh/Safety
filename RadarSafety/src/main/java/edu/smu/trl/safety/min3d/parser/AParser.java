...
public abstract class AParser implements IParser {
    ...
    protected class TextureAtlas {
        ...
        public void addBitmapAsset(BitmapAsset BitmapAsset) {
            BitmapAsset existingBA = getBitmapAssetByResourceID(BitmapAsset.ResourceID);

            if (existingBA == null) {
                int bmResourceID = resources.getIdentifier(BitmapAsset.ResourceID, null, null);
                if (bmResourceID == 0) {
                ...
                BitmapAsset.bitmap = b;
            } else {
                BitmapAsset.bitmap = existingBA.bitmap;
            }

            bitmaps.add(BitmapAsset);
        }
