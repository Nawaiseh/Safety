...
public class BluetoothChatService {
    ...
    public static int ThreasholdDistance = 5;
    public static boolean AlertIsGoing = false;
    public static long LastUpdate = System.currentTimeMillis();
    /*    public TreeMap<Integer, Number3d> CarLocations = new TreeMap<>();
        public TreeMap<Integer, Long> CarsLastUpdates = new TreeMap<>();
        public TreeMap<Integer, Integer> ActiveCars = new TreeMap<>();
        public TreeMap<Integer, Integer> CarsIDs = new TreeMap<>();*/
    public final Renderer_Activity Renderer_Activity;
    ...
    public BluetoothChatService(Renderer_Activity Renderer_Activity, Handler MessageHandler) {
        this.Renderer_Activity = Renderer_Activity;
