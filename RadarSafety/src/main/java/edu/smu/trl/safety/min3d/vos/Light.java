...
public class Light extends AbstractDirtyManaged implements IDirtyParent {
    ...
    /**
     * Used by RendererActivity. Normal clients of this class should use "useSpotProperties" getter/setter.
     */
    public FloatManaged _spotCutoffAngle;
    /**
     * Used by RendererActivity. Normal clients of this class should use attenuation getter/setters.
     */
    ...
    public void commitPositionAndTypeBuffer() {
        ...
        _positionAndTypeBuffer.put((float) position.getX());
        _positionAndTypeBuffer.put((float) position.getY());
        _positionAndTypeBuffer.put((float) position.getZ());
