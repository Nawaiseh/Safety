...
public class Object3d {
    ...
    /**
     * List of object's faces (ie, index FloatBuffer)
     */
    ...
    /**
     * When true, RendererActivity draws using vertex points list, rather than faces list.
     ...
     * rather than using RendererActivity's built-in draw routine.
     * <p/>
