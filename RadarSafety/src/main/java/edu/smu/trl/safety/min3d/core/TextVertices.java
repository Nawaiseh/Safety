...
public class TextVertices {
    ...
    //--Constructor--//
    // D: create the TextVertices/indices as specified (for 2d/3d)
    // A: gl - the gl instance to use
    //    maxVertices - maximum TextVertices allowed in buffer
    //    maxIndices - maximum indices allowed in buffer
    //    hasColor - use color values in TextVertices
    //    hasTexCoords - use texture coordinates in TextVertices
    //    hasNormals - use normals in TextVertices
    //    use3D - (false, default) use 2d positions (ie. x/y only)
    //            (true) use 3d positions (ie. x/y/z)
    public TextVertices(GL10 gl, int maxVertices, int maxIndices, boolean hasColor, boolean hasTexCoords, boolean hasNormals) {
        this(gl, maxVertices, maxIndices, hasColor, hasTexCoords, hasNormals, false);  // Call Overloaded Constructor
    }

    public TextVertices(GL10 gl, int maxVertices, int maxIndices, boolean hasColor, boolean hasTexCoords, boolean hasNormals, boolean use3D) {
    ...
    //--Set Vertices--//
    // D: set the specified TextVertices in the vertex buffer
    //    NOTE: optimized to use integer buffer!
    // A: TextVertices - array of TextVertices (floats) to set
    ...
    //--Draw--//
    // D: draw the currently bound TextVertices in the vertex/index buffers
    ...
    //    numVertices - the number of TextVertices (indices) to draw
    // R: [none]
    ...
    //--Draw Full--//
    // D: draw the TextVertices in the vertex/index buffers
    ...
    //--Set Vertex Elements--//
    // D: use these methods to alter the values (position, color, textcoords, normals) for TextVertices
